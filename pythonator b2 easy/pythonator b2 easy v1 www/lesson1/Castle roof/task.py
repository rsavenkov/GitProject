...
ladder = {"name":"default:ladder_wood","direction":string}
...
range_x_roof_ext = sequence
range_y_roof_ext = sequence
range_z_roof_ext = sequence
...
mc.build(range_x_roof_ext, range_y_roof_ext, range_z_roof_ext, variable)
mc.build(range_x_roof_int, range_y_roof_int, range_z_roof_int, variable)
# build the ladder. Has to be against wall for player to climb it easily.
mc.build(castle_x_min + castle_length - 2, sequence, ref_z, ladder)

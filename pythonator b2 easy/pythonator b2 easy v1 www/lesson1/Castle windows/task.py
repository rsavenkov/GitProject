...
mc.build(range_x_window, range_y_window, (wall_z1, wall_z2), variable)
# add windows on front wall
mc.build(castle_x_min, floor_y + 4, (ref_z - 1, ref_z, ref_z + 1), variable)
